...
;;
(ti-menu-load-string (format #f "/file/write-case-data ./data/tmp/~a_After_Analyzing.cas.h5" ANSYS_Fluent_case_file))
;;
...
(ti-menu-load-string (format #f "/file/write-case-data ./data/tmp/~a_Before_Monitoring.cas.h5" ANSYS_Fluent_case_file))
;;
(ti-menu-load-string (format #f "/solve/set/time-step ~d" ANSYS_Fluent_simulation_timestep))
(ti-menu-load-string (format #f "/solve/dual-time-iterate ~d 30" ANSYS_Fluent_number_of_simulation_timesteps))
(ti-menu-load-string (format #f "/file/write-case-data ./data/tmp/~a_After_Monitoring.cas.h5" ANSYS_Fluent_case_file))
;;
